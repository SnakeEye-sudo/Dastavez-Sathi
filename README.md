...
Mobile-first document scanner app for turning camera captures into clean multi-page PDFs.

- Live website: https://snakeeye-sudo.github.io/Dastavez-Sathi/
...
- `Dastavez Sathi` must feel like a mobile scanner app, not a website page.
- Prioritize app shell, camera-first flow, touch-friendly controls, and compact export actions.
- Keep the `Pariksha-Sathi` family feel as the benchmark for product seriousness and polish.
